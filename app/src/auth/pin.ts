...
//   { saltHex, hashHex, iterations, length, attempts, lastFailedAtMs }
//
// We hash with iterated SHA-256 (expo-crypto's Pbkdf2 isn't available; SHA-256
// is). 100k iterations runs in <100ms on modern phones — plenty for PIN scope.
